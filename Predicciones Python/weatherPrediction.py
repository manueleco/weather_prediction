...
calorPorHumedadMax = (pCondicionalCalorPorHumedadMax*probCalor)/probHumedadMax

pCondicionalCalorPorHumedadMin = (probCalorHumMin)/probCalor
calorPorHumedadMin = (pCondicionalCalorPorHumedadMin*probCalor)/probHumedadMax

pCondicionalCalorPorHumedadMax = (probCalorHumBuena)/probCalor
calorPorHumedadBuena = (
    pCondicionalCalorPorHumedadMax*probCalor)/probHumedadMax

humedadMaxPorCalor = (pCondicionalCalorPorHumedadMax*probHumedadMax)/probCalor


pCondicionalTempBuenaPorHumedadBuena = (probBuenaTempHumBuena)/probBuenaTemp
tempBuenaPorHumedadBuena = (pCondicionalTempBuenaPorHumedadBuena*probBuenaTemp)/probHumedadBuena
...
print("Ocurrencias de temperatura agradable y humedad alta: %2d " %
      (buenClimaHumMax))
print("Ocurrencias de temperatura agradable y humedad baja: %2d " %
      (buenClimaHumMin))
...
print("Probabilidad de temperatura agradable y humedad alta: %5.2f " %
      (probBuenaTempHumMax))
print("Probabilidad de temperatura agradable y humedad baja: %5.2f " %
      (probBuenaTempHumMin))
...
print("Probabilidad de calor dado humedad agradable: %5.2f \n" %
      (calorPorHumedadBuena))

print("Probabilidad de humedad alta dado calor: %5.2f \n" % (humedadMaxPorCalor))

print("Probabilidad de temperatura agradable dado humedad agradable: %5.2f \n" % (tempBuenaPorHumedadBuena))
